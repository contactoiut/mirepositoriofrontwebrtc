...
// =====================================================================================
// !! CRITICAL !!
// YOU MUST REPLACE THIS URL with the one provided by your Render deployment.
// The "Failed to fetch" error will persist if this is not your live server address.
// Example: 'my-signaling-server.onrender.com'
// =====================================================================================
const PEER_SERVER_URL = 'webrtc-signaling-test-server.onrender.com';
  ...
  useEffect(() => {
    ...
    const initialize = async () => {
        ...
        try {
            ...
            addLog('CRITICAL: Please verify the PEER_SERVER_URL in App.tsx and ensure your Render backend is deployed and running.', 'error');
